...
import { overrideXHROpen, waitForElementVideo } from './scripts_spider/runInBrowser.js';
...
class AGE_Anime_Download_auto implements I_AGE_Anime_Download_auto {
    ...
    async run() {
        ...
        try {
            ...
            // await page.evaluateOnNewDocument(overrideXHROpen); todo page.isJavaScriptEnabled
        } catch (err) {
            throw 'run中出错' + err;
        }
    }
